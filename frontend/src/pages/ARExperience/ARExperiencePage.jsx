...
const ARExperiencePage = () => {
  ...
  const arLogic = useARLogic({
    ...
    setTargetDetected: arState.setTargetDetected,
    setVideoPlaying: arState.setVideoPlaying,
    setIsInitialized: arState.setIsInitialized,
    setIsScanning: arState.setIsScanning,
    addDebugMessage,
    resetARState
  });
