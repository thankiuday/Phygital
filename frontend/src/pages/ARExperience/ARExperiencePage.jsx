...
const ARExperiencePage = () => {
  ...
  }, [librariesLoaded, projectData]); // Removed fetchProjectData from deps to prevent duplicate calls
        ...
        <div className="w-full"  style={{ margin: 0, padding: 0, boxSizing: 'border-box' }}>
          ...
          <div
            ...
            style={{ 
              ...
              maxHeight: isHorizontal ? '80vh' : '85vh', // Adjusted for desktop viewing
